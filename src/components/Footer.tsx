      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-body font-lato font-light leading-relaxed mb-4">
              Elite legal services with a commitment to excellence, integrity,
          ...
          <div>
            <h4 className="text-lg font-libre font-bold mb-4 tracking-tight">
              Practice Areas
            </h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-body hover:text-primary transition-colors font-lato font-light"
                >
                  Corporate & M&A
                </a>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-body font-lato font-light">
                  (555) 123-4567
                </span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          <p className="text-body font-lato font-light">
            © 2025 Apex Legal Group. All rights reserved. | Privacy Policy |
            Terms of Service
          </p>
        </div>
      </div>
